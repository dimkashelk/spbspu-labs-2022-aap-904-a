...
void printRow(std::ostream& out, double x, double absError, unsigned int numberMax)
{
  ...
  out << std::setw(15) << std::scientific << std::setprecision(5) << exp(x, absError, numberMax) << " ";
  out << std::setw(15) << std::scientific << std::setprecision(5) << std::exp(x * (-1)) << "\n";
}

void printTable(std::ostream& out, double left, double right, double step, double absError, unsigned int numberMax)
{
  out << std::setw(10) << std::left << "x" << std::setw(15) << std::left << "exp(x)" << std::setw(15) << std::left << "exp(-x)" << "\n";
